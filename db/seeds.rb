...
# Confiserie Nessi
  ...
  Product.create!(name:"La vie", details:"Americano, Compote de pomme", price: 7.90, bakery: Bakery.last, img: "https://images.unsplash.com/photo-1648807671442-bebebd3c1ef1?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1770&q=80")
  Product.create!(name:"Seul en son genre", details:"Corretto, Céréales complets", price: 9.90, bakery: Bakery.last, img: "https://images.unsplash.com/photo-1648808692677-017af08104d6?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1770&q=80")
  ...
  Product.create!(name:"Sans avis", details:"Caramel Macchiato ,Cookies au chocolat", price: 4.90, bakery: Bakery.last, img: "https://images.unsplash.com/photo-1649165878577-ee1cccc3d5e9?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=774&q=80")
  ...
  Product.create!(name:"J'achète !", details:"Chocolat au lait, Smoothie framboise", price: 14.90, bakery: Bakery.last, img: "https://images.unsplash.com/photo-1648864939972-ff2f44fa4a96?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1770&q=80")
  ...
  Product.create!(name:"Facile à trouver", details:"Espresso, Birchermuesli", price: 15.90, bakery: Bakery.last, img: "https://images.unsplash.com/photo-1649165880559-24c3ee073eb5?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=774&q=80")
